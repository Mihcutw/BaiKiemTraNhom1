...
<div class="manage-users-wrapper">
    <div class="container animate-in">
        ...
        <div class="action-buttons">
            <a href="../../page/admin/create_user.php" class="btn btn-add">+ Thêm User</a>
            <a href="../../page/products/create.php" class="btn btn-add">+ Thêm Sản Phẩm</a>
            <a href="../../page/products/update.php" class="btn btn-update">Cập nhật Sản Phẩm</a>
            <a href="../../page/admin/order_management.php" class="btn btn-order">Quản Lý Đơn Hàng</a>
        </div>
...
body {
    ...
    background-image: url(../../images/123.jpg); /* Thêm ảnh nền */
...
.manage-users-wrapper {
    min-height: 100vh;
    padding: 40px 20px;
    position: relative; /* Đảm bảo nội dung nổi trên lớp phủ */
    z-index: 1;
}
