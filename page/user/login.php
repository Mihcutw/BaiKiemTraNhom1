...
if (isset($_SESSION['user_id'])) {
    header("Location: ../../page/user/index2.php");
    exit();
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!$errors) {
        ...
        if ($user && password_verify($password, $user['password'])) {
            ...
            $errors["../../page/user/login"] = "Sai email hoặc mật khẩu!";
        }
    }
}
?>
...
<div class="login-wrapper">
    <div class="login-container">
        ...
        <div class="links">
            <a href="../../page/user/register.php">Đăng Ký</a>
            <a href="../../page/user/reset-password.php">Reset Mật Khẩu</a>
        </div>
    </div>
</div>
