...
<div class="main-content">
    ...
    <div class="user-welcome">
        ...
        <div class="cta-buttons">
            <a href="../../page/user/dashboard.php" class="cta-button dashboard-btn">Vào Dashboard</a>
            <a href="../../page/products/products.php" class="cta-button explore-btn">Khám Phá Sản Phẩm</a>
        </div>
    </div>
    ...
    <div class="suggestions">
        ...
        <div class="suggestion-cards">
            <div class="card">
                ...
                <a href="../../page/user/profile.php" class="card-link">Cập nhật ngay</a>
            </div>
            <div class="card">
                <h4>Sản phẩm mới</h4>
                <p>Khám phá các sản phẩm hot nhất hôm nay.</p>
                <a href="../../page/products/products.php" class="card-link">Xem ngay</a>
            </div>
            <div class="card">
                <h4>Liên hệ hỗ trợ</h4>
                <p>Có thắc mắc? Chúng tôi luôn sẵn sàng giúp bạn.</p>
                <a href="../../page/user/contact.php" class="card-link">Liên hệ ngay</a>
            </div>
        </div>
    </div>
</div>
